...
<section className={`${styles.paddings} relative z-10`}>
    <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{once: false, amount: 0.25}} className={`${styles.innerWidth} mx-auto flex lg:flex-row flex-col gap-6`}>
      ...
      <motion.div variants={fadeIn('right','tween' , 0.2, 1)} className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a]">
      ...
      <motion.div variants={fadeIn('left', 'tween', 0.2, 1)} className='relative flex-1 flex justify-center items-center'>
        <img src="/planet-09.png" alt="planet-09" className='w-full lg:[h-610px] h-full min-h-[210px] object-cover rounded-[40px]'/>
        <motion.div variants={zoomIn(0,4, 1)} className='lg:block hidden absolute  top-[3%] -left-[10%]'>
          <img src="/stamp.png" alt="stamp" className='w-[155px] h-[155px] object-contain'></img>
        </motion.div>
      </motion.div>
